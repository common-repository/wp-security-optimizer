...
$subject = "WP Security Optimizer: Brute Force Attack blocked on " . get_bloginfo( 'url' );
...
$sec_proxy_option = get_option( WP_SEC_OPT_OPTION_CHECKBOX_PROXY );
        ...
        $html_body= '<html>' .
                '<body>'.
                '<img src="' . $image_logo . '" />'.
                '<br /><p style="text-align: center;"><h5 style="color: red;">Brute Force Detected!</h5></p>'.
                'An attacker that attempt to gain unauthorized access to your WordPress installation has been filtered.<br /><br />' .
