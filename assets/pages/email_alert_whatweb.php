...
$subject = "WP Security Optimizer: WhatWeb scan detected!";
...
$sec_proxy_option = get_option( WP_SEC_OPT_OPTION_CHECKBOX_PROXY );
        ...
        $html_body= '<html>' .
                '<body>'.
                '<img src="' . $image_logo . '" />'.
                '<br /><p style="text-align: center;"><h5 style="color: red;">Whatweb Scan Detected!</h5></p>'.
                'An attacker that attempt to fingerprint your WordPress installation has been filtered.<br /><br />' .
